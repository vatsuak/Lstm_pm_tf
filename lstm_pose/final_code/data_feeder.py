...
class Feeder():
    ...
    def normalize(self,im):
        ...
        return cv2.normalize(im, None, alpha=0, beta=1, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_32F)
    ...
    def __getitem__(self, idx):  #returns a 4-tuple with the images corresponding to the index idx 
        """
        :param idx:
        :return:
        ...
        for i in range(self.temporal):          # get temporal images
            ...
            # get image
            im = cv2.imread(img)                # read image of PIL type
            w, h, _ = im.shape      # weight 256 * height 256 * 3
